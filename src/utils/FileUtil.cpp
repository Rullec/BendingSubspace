...
std::string cFileUtil::ConvertToLowerCase(std::string str)
{
...
std::string cFileUtil::GetExtension(const std::string &filename)
{
    ...
    auto ext = str.substr(pos + 1);
    return cFileUtil::ConvertToLowerCase(ext);
}
...
std::string cFileUtil::GetFilename(const std::string &path)
{
    ...
    return cFileUtil::ConvertToLowerCase(filename);
}
...
bool cFileUtil::IsDir(std::string filename)
{
